...
const Client = () => {
  ...
  const { data, isPending } = useGetResend();
        ...
        >
          ...
          <div className="flex items-center gap-2 text-xs md:text-sm justify-center my-3">
            ...
            <Button
              type="button"
              variant={"ghost"}
              className="hover:bg-transparent text-red-500 hover:text-red-600 p-0 h-auto disabled:opacity-70 hover:underline text-xs md:text-sm"
