...
export const NoOrderYet = () => {
  return (
    <div className="flex p-3 border border-red-500 rounded-md gap-3 min-h-52 flex-col items-center justify-center w-full">
      <div className="size-14 md:size-16 rounded-full bg-red-500 flex items-center justify-center flex-none">
        <ShoppingCart className="text-white size-6 md:size-8 flex-none stroke-[1.5]" />
      </div>
      <div className="flex flex-col w-full items-center justify-center">
        <h5 className="font-semibold text-red-500 md:text-lg">
