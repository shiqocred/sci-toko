          ...
          <div className="col-span-1 w-full flex flex-col gap-6">
            <div className="bg-white shadow flex gap-4 p-5 rounded-lg">
              ...
              <div className="flex flex-col w-full gap-1">
                <h5 className="text-lg font-semibold">Hari Fajar</h5>
                <p className="text-gray-500 text-sm">harifajar@mail.com</p>
                <p className="text-gray-500 text-sm">085123123123</p>
                <Badge className="bg-green-50 hover:bg-green-50 border-green-600 text-green-600 rounded-full">
                  Basic User
                </Badge>
              </div>
            </div>
            <Button className="bg-white hover:bg-gray-50 text-black items-center shadow flex gap-3 p-5 rounded-lg h-auto">
              <BadgeCheck className="size-9 text-white fill-sky-500 flex-none" />
              <div className="flex flex-col w-full text-start gap-1">
                <h5 className="text-lg font-semibold">
                  Get a verified Veterinarian
                </h5>
                <p className="text-gray-500 text-sm text-wrap">
                  Verify your KTA to upgrade and purchase the products that
                  require a receipt.
                </p>
              </div>
              <ChevronRight className="size-4 flex-none text-gray-600" />
            </Button>
          </div>
          <div className="w-full col-span-2">
            <div className="w-full rounded-lg overflow-hidden shadow">
              <Tabs defaultValue="order" className="gap-0 h-full">
                          ...
                          <div className="flex p-3 border border-red-500 rounded-md gap-3 items-center">
                            ...
                            <div className="flex flex-col w-full">
                              ...
                              <p className="text-gray-700 text-sm">
                                Explore, shop now, and find amazing deals just
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="flex flex-col gap-2">
                        ...
                        <Input
                          ...
                          className="bg-gray-100 focus-visible:ring-0 shadow-none focus-visible:border-gray-500"
                        />
                      </div>
                      <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-1.5 w-full">
                        ...
                        <div className="w-full relative flex items-center rounded-md overflow-hidden bg-red-200">
                          <Input
                            id="phone-number"
                            className="bg-gray-100 border-gray-100 focus-visible:ring-0 focus-visible:border-gray-500 shadow-none pl-20"
                          ...
                          <div className="absolute left-2 flex items-center justify-center w-16">
                            <Popover open={isOpen} onOpenChange={setIsOpen}>
                              <PopoverTrigger asChild>
                                <Button className=" h-auto w-fit !px-1 !py-0.5 rounded-full gap-1 text-xs shadow-none bg-white text-black hover:bg-gray-200">
                                  {dialCode}
                                  <ChevronDown />
                                </Button>
                              </PopoverTrigger>
                ...
                <TabsContent
                  value="password"
                  className="bg-white p-5 flex flex-col text-sm gap-3"
                >
                  <div className="flex flex-col gap-2">
