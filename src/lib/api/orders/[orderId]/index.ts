...
export const detailOrder = async (
  ...
  return {
    ...
    timestamp: {
      expiredAt: orderRes.expiredAt?.toISOString() ?? null,
      cancelledAt: orderRes.cancelledAt?.toISOString() ?? null,
      paidAt: orderRes.paidAt?.toISOString() ?? null,
      shippingAt: orderRes.shippingAt?.toISOString() ?? null,
      createdAt: orderRes.createdAt?.toISOString() ?? null,
      deliveredAt: orderRes.deliveredAt?.toISOString() ?? null,
    },
